...
test = kirkwoods.Simulation(2, 150, 0.001)
...
plt.plot(0, 0, 'o', lw=8)  # Sun cuz it doesnt show stuff for test.Sun.pos ??
plt.legend(fontsize=12, frameon=True, fancybox=True, edgecolor="#00AA00", loc="lower left")
plt.show()
